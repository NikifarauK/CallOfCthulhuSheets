...
namespace CallOfCthulhuSheets.ViewModels
{
    public class OccupationViewModel : BaseViewModel
    {
        ...
        private async Task RefreshAllSkills()
        {
            ...
            var ocups = SqliteRepo.GetItemsAsync<Occupation>();

            var sklls = (SqliteRepo.GetItemsAsync<Skill>())
        ...
        private async Task RefreshSkillTypes()
        {
            ...
            SkillTypes.Clear();
            SkillTypes.Add(null);
            var t = SqliteRepo.GetItemsAsync<SkillType>();
        ...
        private async Task SaveAndChoose()
        {
            ...
            SqliteRepo.AddItemAsync(ChosenOccup);
